...
var tree = {
     ...
     *
     */
    draw: function (ctx, h, w, spread, leaves, leaveType, maxDepth, lengthFactor, maxBranchWidth, colour) {
        ...
        if (maxBranchWidth >= 1 && maxBranchWidth <= 40) {
        ...
        this.ctx.lineWidth = 1 + (Math.random() * this.maxBranchWidth);
